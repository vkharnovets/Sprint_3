# Registration form
reg_form_name_input = './/form/fieldset[1]/div/div/input' #Окно для ввода имени
reg_form_email_input = './/form/fieldset[2]/div/div/input' #Окно для ввода email
reg_form_password_input = './/form/fieldset[3]/div/div/input' #Окно для ввода пароля
reg_form_confirm_button = './/form/button' #Кнопка отсылки данных
...
# Login form
login_form_email_input = './/form/fieldset[1]/div/div/input' #Окно для ввода email
login_form_password_input = './/form/fieldset[2]/div/div/input' #Окно для ввода пароля
login_form_login_button = './/form/button' #Кнопка отсылки данных
